OC.L10N.register(
    ...
    "Lost password mail (HTML)" : "Письмо о потерянном пароле (HTML)",
    "Lost password mail (plain text fallback)" : "Письмо о потерянном пароле (запасной вариант простым текстом)",
    "Password changed notification mail (HTML)" : "Письмо об изменении пароля (HTML)",
    "Password changed notification mail (plain text fallback)" : "Письмо об изменении пароля (запасной вариант простым текстом)",
